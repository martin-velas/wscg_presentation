...
\begin{document}
	...
	\begin{frame}{Usage of the camera-LiDAR fusion}
		...
		\begin{figure}[h]
			\centering
			\subfloat{
				\includegraphics[width=1.0\textwidth]{fig/camera_image.png}\label{subfig:camera-img}}
			\\
			\subfloat{
				\includegraphics[width=1.0\textwidth]{fig/gray_cloud.png}\label{subfig:gray-scan}}
		\end{figure}
			\end{minipage} \begin{minipage}{0.47\textwidth}
		\begin{figure}[h]
			\centering
			\subfloat{
				\includegraphics[width=1.0\textwidth]{fig/colored_cloud.png}\label{subfig:color-scan}}
		\end{figure}
